...
export default function CatalogueForm({
  ...
  return <div className="space-y-6">
      {!isInline && <div className="flex items-center gap-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormField control={form.control} name="tipo_catalogo" render={({
                field
              }) => <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          {tiposCatalogo.map(tipo => <SelectItem key={tipo.value} value={tipo.value}>
                              {tipo.label}
                            </SelectItem>)}
                        </SelectContent>
                      </Select>
              ...
              field
                    ...
                    <FormControl>
                      <Textarea placeholder="Descreva o conteúdo deste catálogo..." className="min-h-[100px]" {...field} />
                    </FormControl>
                    <FormDescription>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField control={form.control} name="ordem_exibicao" render={({
                field
              }) => <FormItem>
