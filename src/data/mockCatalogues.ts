...
export const mockCatalogues: Catalogue[] = [
  {
    ...
    cover_url: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-classics.png",
    bannerImageUrl: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-thegamechanger.png",
    badge: "NEW",
    ageRating: "L",
    enabled: true,
    status: true,
  ...
  {
    id: "2",
    titulo: "Club Profiles",
    descricao: "Documentário sobre os principais jogadores da federação",
    tipo_catalogo: "serie",
    genre: ["Interviews", "Documentary"],
    cover_url: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-clubprofiles.png",
    bannerImageUrl: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-thenextgeneration.png",
    badge: "NEW EPISODES",
    ageRating: "12+",
    enabled: true,
    status: true,
  ...
  },
  {
    ...
    cover_url: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-courtvision.png",
    bannerImageUrl: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-seasonofdunk.png",
    status: true,
    ordem_exibicao: 3,
  ...
  {
    id: "4",
    titulo: "From the Streets",
    descricao: "Vídeos educativos para atletas e treinadores",
    tipo_catalogo: "playlist",
    genre: ["Training", "Educational"],
    cover_url: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-fromthestreets.png",
    status: true,
    ordem_exibicao: 4,
    releaseYear: 2024,
  ...
  {
    id: "5",
    titulo: "Season Of Dunks",
    descricao: "Retrospectiva histórica do basquete estadual",
    tipo_catalogo: "serie",
    genre: ["Documentary", "Institutional"],
    cover_url: "https://syjavjcfemexcqkemcsi.supabase.co/storage/v1/object/public/catalogue/cardImageUrl/cardcontent-seasonofdunk.png",
    status: false,
    ordem_exibicao: 5,
    conteudos: [],
    seasons: [],
...
export const mockBanners = [
  {
    ...
    midia_url: "/assets/Backgroundfnb.png",
    midia_tipo: "image",
    exibir_botao: true,
  ...
  },
  {
    ...
    midia_url: "/assets/736ea3c4-4ba8-4dd3-84ef-adbda2ce6750.png",
    midia_tipo: "image",
    exibir_botao: true,
